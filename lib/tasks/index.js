...
module.exports = function(options) {
	...
	gulp.task(taskPrefix + 'build:js', [taskPrefix + 'soy'], function(done) {
		runSequence.apply(null, [].concat(options.mainBuildJsTasks).concat([done]));
	});
	...
	gulp.task(taskPrefix + 'watch', function(done) { // jshint ignore:line
		gulp.watch(options.buildSrc, function() {
			runSequence.apply(null, [].concat(options.mainBuildJsTasks));
		});
